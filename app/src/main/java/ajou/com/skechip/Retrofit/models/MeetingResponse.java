...
public class MeetingResponse {
    ...
    public MeetingResponse(boolean error, List<Integer> idList, List<Integer> typeList, List<Integer> managerList, List<String> titleList, List<String> placeList, List<Integer> cellPositionList, Integer totalCount, Integer groupId) {
        this.error = error;
        this.idList = idList;
